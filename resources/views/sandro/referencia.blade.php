        ...
        <div class="reference-carousel">
            <div class="reference-track" id="track">
                ...
                <div class="reference-item">
                    <img src="images/descarga.jfif" alt="Cliente 1" />
                ...
                <div class="reference-item">
                    <img src="images/images.jfif" alt="Cliente 3" />
                ...
                <div class="reference-item">
                    <img src="{{ asset('images/199104012-young-and-handsome-bearded-man-wearing-white-t-shirt.jpg') }}"
                        alt="Cliente 4" />
                ...
                <div class="reference-item">
                    <img src="{{ asset('images/images (1).jfif') }}" alt="Cliente 5" />
                ...
                <div class="reference-item">
                    <img src="{{ asset('images/istockphoto-1090878494-612x612.jpg') }}" alt="Cliente 6" />
