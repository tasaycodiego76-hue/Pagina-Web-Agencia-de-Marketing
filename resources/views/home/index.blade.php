...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/sandro/.css') }}">
@endpush
        ...
        <div class="why-choose-us">
            ...
            <div class="why-choose-us-content">
                <div class="why-choose-us-item">
                    ...
                    <p>Nuestras estrategias de marketing no solo se adaptan a las tendencias del mercado, sino que también
                        ofrecen un enfoque creativo e innovador. ¡Con nosotros, tu marca no solo será vista, sino recordada!
                    </p>
                </div>
                <div class="why-choose-us-item">
                    <img src="images/home-imagenes/icon2.png" alt="Icono 2">
                    <h3>Experiencia Comprobada</h3>
                    <p>Contamos con un equipo de expertos con más de una década de experiencia en el sector, dedicados a
                        brindar resultados sobresalientes y a construir relaciones duraderas con nuestros clientes.</p>
                </div>
            </div>
            <div class="stats">
                <div class="stat">
                ...
                <div class="faq-questions">
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Depende del tipo de sesión, pero en promedio duran entre 1 a 2 horas para obtener los mejores
                                resultados sin prisa.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Sí, todas las fotos entregadas pasan por un proceso de selección y edición profesional para
                                asegurar la mejor calidad.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Recomendamos reservar con al menos 2 semanas de anticipación, especialmente para fines de
                                semana o eventos especiales.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Incluye asesoría, sesión fotográfica, edición profesional y entrega digital. También
                                ofrecemos opciones impresas.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Estamos disponibles para responder cualquier pregunta adicional que tengas. Contáctanos a
                                través de nuestro formulario o redes sociales.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="hc-form-wrap">
                    <form id="hc-form" class="hc-form" method="POST" action="{{ route('contacto.submit') }}">
                        ...
                        <div class="hc-form-group" style="margin-bottom: 38px;">
                            <input type="text" id="hc-phone" name="phone" placeholder="Número telefónico *" maxlength="9"
                                required oninput="validatePhone(this)" oninvalid="customPhoneMessage(this)">
                            <div class="hc-input-underline"></div>
                        ...
                        <div class="hc-form-group">
                            <textarea id="hc-message" name="message" rows="5"
                                placeholder="Describe tu proyecto: tipo de sesión, fecha estimada y locación..."
                                required></textarea>
                    ...
                    <div id="modal-data" data-success="{{ htmlspecialchars(session('success'), ENT_QUOTES) }}"
